...
class SearchHistoryFood extends StatefulWidget {
  const SearchHistoryFood({Key? key}) : super(key: key);
...
class _SearchHistoryFoodState extends State<SearchHistoryFood> {
  FoodSearchDelegate? _delegate;
  SearchHistoryFoodPageModel? _historyPage;

  @override
  void initState() {
    super.initState();
    _delegate = FoodSearchDelegate(onProductDetail: _onProductDetail);
    _loadData();
  }
